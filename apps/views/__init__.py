from .auth_views import UserChangePasswordView, UserChangeImageView, UserLogautView, UserSettingsView, \
    UserLoginView, OperatorDetailView, OperatorOrderListView, OperatorCreateOrderView, CurrierOrderListView, \
    CurrierListView, \
...
from .shop_views import StatisticView, StreamCreateView, StreamListView, CreatedSuccessOrderedView, CompetitionListView, \
    FavouriteListView, FavoriteView, OrderListView
from .utils_views import DiagramView, HeaderSearchView, TransactionCreateView, DistrictListView, CoinsView, \
    InquiriesView, Transaction
